...
public class AdministrativActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrativ);
    ...
    private void prepareData() {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("documentsAdministratifs");
