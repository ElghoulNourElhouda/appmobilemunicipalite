...
public class CollectionLocal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collection_local);
    ...
    private void prepareData() {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("CollectionLocal");
