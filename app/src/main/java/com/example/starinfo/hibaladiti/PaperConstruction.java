...
public class PaperConstruction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paper_construction);
    ...
    private void prepareData() {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("permissionDeConstruires");
